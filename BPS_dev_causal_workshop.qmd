...
#     col = "black",
#     size=8,
#     label = c(expression(bold("X")), 
#               expression(bold("W")), 
#               expression(bold("Y")), 
#               expression(bold("Z")), 
#               expression(epsilon["X"]), 
#               expression(epsilon["W"]),
#               expression(epsilon["Y"]),
#               expression(epsilon["Z"]))
#   ) +
#   theme_dag()
...
#     col = "black",
#     size=8,
#     label = c("W", "X", "Y", expression(Z[1]), expression(Z[2]), expression(Z[3]))
#   ) +
#   theme_dag()
